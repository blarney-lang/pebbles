...
module module_wrap64_getTop(wrap64_getTop_cap,
  ...
  wire [32 : 0] addTop__h57, result__h501, ret__h59;
  wire [24 : 0] mask__h58;
  ...
  // remaining internal signals
  assign addTop__h57 =
	     { {23{x__h167[9]}}, x__h167 } << wrap64_getTop_cap[31:26] ;
  assign mask__h58 = 25'd33554431 << wrap64_getTop_cap[31:26] ;
  assign result__h501 = { ~ret__h59[32], ret__h59[31:0] } ;
  assign ret__h59 =
	     { { 1'b0, wrap64_getTop_cap[89:66] } & mask__h58, 8'd0 } +
	     addTop__h57 ;
  ...
  assign x__h167 = { wrap64_getTop_cap[3:2], wrap64_getTop_cap[25:18] } ;
