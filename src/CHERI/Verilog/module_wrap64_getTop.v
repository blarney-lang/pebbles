...
module module_wrap64_getTop(wrap64_getTop_cap,
  ...
  wire [32 : 0] addTop__h56, result__h500, ret__h58;
  wire [24 : 0] mask__h57;
  ...
  // remaining internal signals
  assign addTop__h56 =
	     { {23{x__h166[9]}}, x__h166 } << wrap64_getTop_cap[31:26] ;
  assign mask__h57 = 25'd33554431 << wrap64_getTop_cap[31:26] ;
  assign result__h500 = { ~ret__h58[32], ret__h58[31:0] } ;
  assign ret__h58 =
	     { { 1'b0, wrap64_getTop_cap[89:66] } & mask__h57, 8'd0 } +
	     addTop__h56 ;
  ...
  assign x__h166 = { wrap64_getTop_cap[3:2], wrap64_getTop_cap[25:18] } ;
